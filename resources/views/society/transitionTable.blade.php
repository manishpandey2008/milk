			...
			<ul class="list-unstyled components">
				...
				<li>
					<a href="#vehicle" data-toggle="collapse" aria-expanded="false">
						<span class="ti-truck"></span> Vehicle
					</a>
				...
				<li>
					<a href="#plant" data-toggle="collapse" aria-expanded="false">
						<span class="ti-truck"></span> Plant
					</a>
		...
		<div id="content">
			...
			<div class="container-fluid home ">
				...
				<div class="container-fluid widget-area proclinic-box-shadow  my-3">
					<h3 class="text-center"><u>Transition Table</u></h3>
					<div class="row">
							...
							<table class="table text-center table-bordered table-hover table-striped " >
							  <thead >
							    <tr>
							      ...
							      <th scope="col">Transition Price(₹)</th>
							      <th scope="col">Transition Method</th>
							  ...
							  <tbody>
							    <tr>
							      	...
							      	<td>
							      	    <span class="ti-menu color-red" id="sidebarCollapse "></span>
							      	</td>
							      <td>tr1</td>
							      <td>farmer</td>
							      <td>farmer001</td>
