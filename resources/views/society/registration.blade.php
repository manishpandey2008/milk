		...
		<div id="content">
			...
			<div class="container-fluid home ">
				...
				<h3 class="text-center"><u>{{$role}} Registration Form</u></h3>
					<form method="post" action="{{route('society.otpverification',['id'=>$user_id,'role'=>$role])}}" onsubmit="return checkPassword(this)">
						@csrf
						<div class="row">
			               <div class="col-lg-4 col-sm-12  my-2">
			                  <label>Working Role<span class="text-danger">*</span></label>
			                    <input type="text" class="form-control" value="{{$role}}" readonly="" name="role">
			                </div>
