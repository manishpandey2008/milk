	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="container-fluid home ">
				...
				<h3 class="text-center"><u>{{$role}} Registration Form</u></h3>
					<form method="post" action="{{route('society.otpverification')}}" onsubmit="return checkPassword(this)" enctype="multipart/form-data">
						@csrf
						<div class="row">
			               <div class="col-lg-4 col-sm-12  my-2">
			                  <label>Working Role<span class="text-danger">*</span></label>
			                    <input type="text" class="form-control" value="{{$role}}" readonly="" name="role" required="">
			                </div>
    						<div class="col-lg-4 col-sm-10  my-2">
    							<label>First Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter " required="" id="first_name" name="first_name" pattern="[a-zA-Z\s]{,30}" title="Max Length Of String is 30">
    						</div>
    						<div class="col-lg-4 col-sm-10  my-2">
    							<label>Mid Name</label>
                                <input type="text" class="form-control" placeholder="Enter " id="mid_name" name="mid_name" pattern="[a-zA-Z\s]{,30}" title="Max Length Of String is 30">
    						</div>
                            <div class="col-lg-4 col-sm-10  my-2">
                                <label>Last Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control"placeholder="Enter " required="" id="last_name" name="last_name" pattern="[A-Za-z]{,30}" title="Max Length Of String is 30">
                            </div>
                            <div class="col-lg-4 col-sm-10  my-2">
                            ...
                            <div class="col-lg-4 col-sm-10  my-2">
                                <label>Password<span class="text-danger">*</span></label>
                                <input type="file" class="form-control" placeholder="Enter " name="photo" required="">
                            </div>
				...
				<div class="container-fluid my-3 widget-area ">
					<div class="row footer">
						<div class="col-12 text-center my-5">
							...
							<h6><strong>Plant ( {{$user['creater_user_id']}} )</strong></h6>
