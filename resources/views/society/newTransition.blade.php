		...
		<!-- Top Navigation -->
			...
			<div class="container-fluid home ">
				<div class="container-fluid widget-area proclinic-box-shadow  my-3">
					...
					<form method="post" action="{{route('society-addTransaction')}}" enctype="multipart/form-data">
						@csrf
						<div class="row">
