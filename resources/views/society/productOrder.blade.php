			...
			<ul class="list-unstyled components">
				...
				<li class="active">
					...
					<ul class="collapse list-unstyled show" id="plant"> 
						<li>
							<a href="{{route('society-order-list',['id'=>$user['user_id']])}}">All Orders List</a>
						</li>
						<li>
					...
					<div class="row collapse" id="collapseExample">
						<div class="col-12 table-responsive my-4">
							...
							<div class="col-4 mx-auto">
								<form method="post" action="{{ route('society-order-product',['id'=>$user['user_id']])}}">
									@csrf
				    ...
				    <div class="modal-content">
				      <div class="modal-body">
				       <h5 class="text-center"><strong>Product Addition</strong></h5>
				        ...
				        <form method="post" action="{{ route('society.addcart',['id'=>$user['user_id']])}}" id="add_product_form">
				        	@csrf
							<div class="row">
