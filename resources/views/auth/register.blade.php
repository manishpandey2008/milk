            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="l_name" class="col-md-4 col-form-label text-md-right">{{ __('L_Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="working_role" class="col-md-4 col-form-label text-md-right">{{ __('Working Role') }}</label>

                            <div class="col-md-6">
                                <input id="working_role" type="text" class="form-control @error('working_role') is-invalid @enderror" name="working_role" value="{{ old('working_role') }}" required autocomplete="working_role" autofocus>
