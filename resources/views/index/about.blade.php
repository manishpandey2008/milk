...
<div class="about-page">
	<div class="container">
		...
		<div class="col-md-6 about-left">
            <div class="about_img"><img src="images/ab1.jpg" alt="">
              <h5>Tilling</h5>
              <div class="about_opa">
                <p>Sed ut perspiciatis unde omnis iste natus error sit
				voluptatem accusantium unde omnis iste natus error sit voluptatem accusantium.</p>
              </div>
            </div>
        </div>
		<div class="col-md-6 about-left">
            <div class="about_img"><img src="images/ab2.jpg" alt="">
              <h5>Tilling</h5>
              <div class="about_opa">
                <p>Sed ut perspiciatis unde omnis iste natus error sit 
				voluptatem accusantium unde omnis iste natus error sit voluptatem accusantium.</p>
		...
		<p class="para_abt">Temporibus autem quibusdam et aut officiis 
		...
		<div class="col-md-4 team-gd">
            <div class="thumb">
				...
				<div class="team_pos">
					<ul>
						<li>
							<a href="#"><div class="morph pic fb_icon1">
								
							</div></a>
						</li>
						<li>
							<a href="#"><div class="morph pic fb_icon2">
								
							</div></a>
						</li>
						<li>
							<a href="#"><div class="morph pic fb_icon3">
