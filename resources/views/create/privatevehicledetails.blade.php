	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">Add Private Vehicle </h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
					...
					<div class="col-md-4 col-sm-10 mx-auto ">
						<div class="widget-area proclinic-box-shadow ">
							<div class="widget-right">
								<h2 class="wiget-title"> <strong>PRIVATE VEHICLE</strong>  </h2>							
							</div>
						</div>
					</div>
				</div>
					...
					<form method="post" action="{{route('privatevehicledetails',['id'=>$user_id,'role'=>$role])}}">
						...
						<div class="row">
							<div class="col-lg-4 col-sm-10  my-2">
                                <label>Category of Vehicle<span class="text-danger">*</span></label>
			               ...
			               <div class="col-lg-4 col-sm-12  my-2">
			                  <label>Vehicle No.<span class="text-danger">*</span></label>
			                    <input type="text" class="form-control" placeholder="Enter Vehicle No" required="" name="vehicleNumber" pattern="[a-zA-Z0-9\s]*" maxlength="20">
			                </div>
    						<div class="col-lg-4 col-sm-10  my-2">
                                <label>Driver</label>
