	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">Add Farmer </h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
					...
					<div class="col-md-4 col-sm-10 mx-auto ">
						<div class="widget-area proclinic-box-shadow ">
							<div class="widget-right">
								...
								<h2 class="wiget-title"> <strong>FARMER</strong>  </h2>
								<p>{{$create_user_id}}</p>
			               ...
			               <div class="col-lg-4 col-sm-12  my-2">
    						...
    						<div class="col-lg-4 col-sm-10  my-2">
                                ...
                                <select class="form-control" name="bmcId" required="">
                                	...
                                	<option value="{{$ddl['user_id']}}">{{$ddl['user_id']}}</option>
                                	@endif
                                	@endforeach
    						...
    						<div class="col-lg-4 col-sm-10  my-2">
    							<label>Society ID<span class="text-danger">*</span></label>
                                 <select class="form-control" required="" name="societyId">
                                	<option value="">--* Select One *--</option>
                                	@foreach($dropDownList as $ddl)
                                	@if($ddl['working_role']=='society')
                                	<option value="{{$ddl['user_id']}}">{{$ddl['user_id']}}</option>
                                	@endif
                                	@endforeach
                            ...
                            <div class="col-lg-4 col-sm-10  my-2">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Pin Code " pattern="[0-9]{6}"  required="" name="pinCode">
                            </div>
                            <div class="col-lg-4 col-sm-10  my-2">
                            ...
                            <div class="col-lg-4 col-sm-10  my-2">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Acount Number"  required="" pattern="[0-9]*" title="Enter only numeric val" name="actNumber" maxlength="30">
                            </div>
                            <div class="col-lg-4 col-sm-10  my-2">
                                <label>IFSC Code<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Bank IFSC Code"  required="" pattern="[a-zA-Z0-9]*" title="Max Length Of String is 30" name="ifscNumber" maxlength="30">
                            </div>
                            <div class="col-lg-4 col-sm-10  my-2">
