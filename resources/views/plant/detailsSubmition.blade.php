...
@endforeach
				...
				<div class="container-fluid widget-area proclinic-box-shadow color-green my-5">
					<h4 class="text-center py-3">Details Submission</h4>
					<div style="width: 100%;height: 2px;background-color: black"></div>
					<form method="POST" action="{{route('checkphonenumber',['id'=>$user_id])}}">
						@csrf
						<div class="row">
							<div class="col-lg-4 col-sm-10  my-2">
				              <input type="text" class="form-control"  name="phoneNumber" placeholder="Enter Register Phone Number">
				              @if($error)
