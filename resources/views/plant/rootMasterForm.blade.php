...
<body>
	...
	@foreach($users as $user)
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">New Root</h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
					...
					<form method="post" action="{{route('addrootmaster',['id'=>$user_id])}}" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-lg-4 col-sm-10  my-2" id="vill_list">
							    <label>Root For <span class="text-danger">*</span></label>
							    <select class="form-control" required="" name="rootfor">
							    	<option value="">--* Select One *--</option>
							    	<option value="milkcollection">Milk Collection</option>
							    	<option value="milksupply">Milk Supply</option>
							    	<option value="random">Random Root</option>
							    </select>
							</div>
							<div class="col-lg-4 col-sm-10  my-2">
							    <label>Root Name <span class="text-danger">*</span></label>
							    <input type="text" class="form-control"  placeholder="Enter Root Name" name="rootname" pattern="[a-zA-Z0-9\s]{,50}" title="Max Length Of String is 50" required>
							</div>
							<div class="col-lg-4 col-sm-10  my-2">    
							    <label>Root expenses<span class="text-danger">*</span></label>
							    <input type="number" class="form-control"  placeholder="Enter Root Expenses" required=""  name="rootExpenses" min="0">
							</div>
							<div class="col-lg-4 col-sm-10  my-2" id="vill_list">
							    <label>Vehicle Appointment<span class="text-danger">*</span></label>
							...
							<div class="col-lg-4 col-sm-10  my-2">    
							    <label>Root Length<span class="text-danger">*</span></label>
							    <input type="number" class="form-control"  placeholder="Enter Root Length" required=""  name="rootLength" min="0">
							</div>
							 <div class="col-lg-4 col-sm-10  my-2" id="vill_list">
