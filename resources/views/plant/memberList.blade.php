		...
		<div id="content">
			...
			<div class="container-fluid home">
				<div class="container-fluid widget-area proclinic-box-shadow  my-3">
					<h4 class="text-center my-3">All Members Table</h4>
					...
					<div class="row">
						<div class="col-12" >
							<table class="table table-responsive-lg table-bordered table-hover table-striped text-center" id="member_list">
									<thead>
										<tr>
